      ...
      >
        <div className="row align-items-center position-relative z-1">
          <div className="col-lg-8">
            ...
            <p className="text-white mb-0 small leading-snug max-w-2xl" style={{ fontSize: '0.825rem' }}>
          ...
          <div className="col-lg-4 text-center text-lg-end mt-2.5 mt-lg-0">
            <div className="d-inline-flex p-2 rounded-3 bg-white bg-opacity-10 border border-white border-opacity-20">
              <span className="text-white small me-2" style={{ fontSize: '0.75rem' }}>Production Mode:</span>
              <strong className="small fw-bold text-nowrap text-white" style={{ fontSize: '0.75rem' }}>Live Data</strong>
            </div>
          </div>
        </div>
      </div>
